...
$app_file = array(
"input" =>  "xml/".$input_file.".xml",
"output" => "sql/".$input_file.".sql"
);
...
echo ">>> ".$app_file["output"]." Data written to the file successfully";
}
...
<body>
	<form action="" method="post">
		<input type="text" name="file" placeholder="Název souboru"><br>
		<input type="submit" name="download" value="Stáhnout soubor sql">
	</form>
</body>
</html>